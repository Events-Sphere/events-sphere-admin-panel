        ...
        <tbody>
          {data.map((item, index) => (
            <tr className={`border-b ${index % 2 === 0 ? 'bg-grey' : 'bg-light-gray'}`} key={index}>
              ...
              <td className={item.V_status === 0 ? "py-4 px-6  text-red-700 font-semibold rounded-lg text-center" : "py-4 px-6  text-green-700 font-semibold rounded-lg text-center"}>
