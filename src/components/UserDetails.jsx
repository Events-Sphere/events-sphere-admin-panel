...
const UserDetails = ({ popup, setPopup, userDetail }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center w-full  bg-black bg-opacity-75 pt-8 pb-8">
      <div className="bg-white px-8 py-3 rounded-lg shadow-lg  w-full h-full max-w-md overflow-scroll ">
        <div className="flex justify-between items-center">
          <h1 className="text-xl font-bold mb-4 text-primary">USER DETAIL</h1>
          <span
...
{
  userDetail?(userDetail.map((data)=>
    <p className="text-black">email: {data.email}ji</p>
  )): 
  (<p>..LODING</p>)
}
        {/* {userDetail.length <= 0 ? (
                ...
                {data.user_role === "organizer" ? (
                  ...
                  <div>
                    ...
                    <div className="flex justify-start">
                      ...
                      <p>
                        <span className="font-bold pl-6">Status: </span>
                        {data.verified_status}
                      </p>
                    </div>
                    {data.reason !== "no reason" && (
