        ...
        <div className="flex gap-3 ">
          ...
          {userCategory.map((role, index) => (
            ...
            <div
              key={index}
              id={role}
              className={`px-4 py-1 rounded-md text-white cursor-pointer items-center self-center  ${selectedRoles.includes(role) ? "bg-[#2F3645]" : "bg-gradient-to-r from-[#6d879b] via-[#526D82] to-[#bed1df]"}`}
